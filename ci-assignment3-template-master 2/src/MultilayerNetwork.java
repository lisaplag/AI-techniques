...
public class MultilayerNetwork {
    ...
    public ArrayList<Integer> productsOfClass(int productClass1, int productClass2, int productClass3, int[] classes) {
        ArrayList<Integer> list = new ArrayList<>();
        for (int i = 0; i < classes.length; i++) {
            if (classes[i] + 1== productClass1 || classes[i] +1 == productClass2 || classes[i] +1 == productClass3) {
                list.add(i);
            }
        }
        return list;
